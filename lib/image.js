...
function sprite(array , fileName , direction){
    ...
    this.create = function(){
        ...
        array.forEach(function(obj){
            // 对图片进行填充
            if(obj.path.indexOf("full") != -1){
                console.log(obj.fit.x , obj.ml , obj.fit.y , obj.mt);
                console.log(obj.image.width , obj.image.height , obj.fit.x + obj.ml , obj.fit.y + obj.mt);
            }
...
function create(file , type){
    new sprite(data.images() , file , type);
};
